...
${USERNAME}       BF
${PASSWORD}       BF
@{SRV_LIST} 	  AirDisk 	AirPlay 	AirPortManagement 	 	AirPrint  	AirTunes  	AppleFileSharing  	AppleMobileDevices  	AppleTV  	iCloudSync  	iTunesRemote  	iTunesSharing  	OpenDirectoryMaster  	OpticalDiskSharing  	RuckusController  	ScreenSharing  	SecureFileSharing  	SecureShell  	WorldWideWeb  	WorldWideWebSSL  	WorkgroupManager  	Xgrid  	  	  	  	
${MIN_SRV_NUM} 	  1
${MAX_SRV_NUM} 	 22
